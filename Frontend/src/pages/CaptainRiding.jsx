  ...
  return (
    <div className="h-screen relative">
        ...
        >
          ...
          <button className="bg-green-600 text-white font-semibold p-3 px-10 rounded-lg mt-2">Complete Ride</button>
        </div>

        <div ref={finishRidePanelRef} className="fixed w-full z-10 bottom-0 translate-y-full bg-white pt-12 py-10 px-3">
